...
pub use commands::{
    ...
    __cmd__builtin_ai_get_models_directory, __cmd__builtin_ai_is_model_ready,
    __cmd__builtin_ai_list_models, __cmd__builtin_ai_open_models_folder,
    builtin_ai_cancel_download, builtin_ai_delete_model, builtin_ai_download_model,
    builtin_ai_get_model_info, builtin_ai_get_models_directory, builtin_ai_is_model_ready,
    builtin_ai_list_models, builtin_ai_open_models_folder, init_model_manager, ModelManagerState,
};
